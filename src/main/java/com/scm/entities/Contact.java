...
public class Contact {
    ...
    public Contact(String id, String name, String email, String phoneNumber, String address, String picture, String description, boolean favorite, String websiteLink, String linkedInLink, String cloudinaryImagePublicId, User user, List<SocialLink> links) {
        this.id = id;
        this.name = name;
        this.email = email;
